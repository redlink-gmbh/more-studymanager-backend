-- Update gateway-view to include observation groups
CREATE OR REPLACE VIEW auth_routing_info (api_id, api_secret, study_id, participant_id, study_group_id, study_is_active, participant_is_active, observation_group_ids) AS
